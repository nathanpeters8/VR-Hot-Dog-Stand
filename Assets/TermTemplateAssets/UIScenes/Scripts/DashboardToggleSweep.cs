...
public class DashboardToggleSweep : MonoBehaviour
{
    ...
    void Update()
    {
        if (gesture.isRotatingDown && gesture.isFacingDown)     //We check whether the user is in
            OpenDashboard();                                    //the RotatingDown and FacingDown gesture.
                                                                //If so, we activate the dashboard.
